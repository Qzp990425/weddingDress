...
<body>
    ...
    <div class="wrapper" style="width:1250px;height:800px;margin-left:-10px;margin-top:-20px">
        ...
        <div class="page-content">
          <div class="content">
            <!-- 右侧内容框架，更改从这里开始 -->
            <form action="${pageContext.request.contextPath}/dress/addDress" method="post" enctype="multipart/form-data" class="layui-form">
                <div class="layui-form-item">
                    <label for="L_username" class="layui-form-label">
                        <span class="x-red">*</span>婚纱名称
                    </label>
				...
				<div class="layui-form-item">
                    <label for="L_repass" class="layui-form-label">
                        <span class="x-red">*</span>婚纱类型
                    </label>
                    <div class="layui-input-inline">
                    	<select id="L_repass" name="color" required="" lay-verify="repass"
                        autocomplete="off" class="layui-input">
                ...
                <div class="layui-form-item">
                    <label for="L_pass" class="layui-form-label">
                        <span class="x-red">*</span>上架数量
                    </label>
                    <div class="layui-input-inline">
                        <input type="text" id="L_pass" name="number" required="" lay-verify="pass"
                        autocomplete="off" class="layui-input">
                    </div>
                </div>
				<div class="layui-form-item">
                    <label for="L_repass" class="layui-form-label">
                        <span class="x-red">*</span>婚纱照片
                    </label>
                    <div class="layui-input-inline">
                        <input type="file" id="L_repass" name="dressImg" required="" lay-verify="repass"
                        autocomplete="off" class="layui-input">
                    </div>					
                </div>
                <div class="layui-form-item">
                    ...
                    <input type="submit"  class="layui-btn" lay-filter="add" lay-submit="" value="添加婚纱">
                </div>
            </form>
