        ...
        <div class="page-content">
          <div class="content">
            ...
            <table class="layui-table" style="text-align:center">
                <thead >
                	<tr>
                      <th style="text-align:center;">地区id</th>
                ...
                <tbody>
                	<c:forEach var="region" items="${pageInfo.list}">
                      <tr style="height:120px;">	           			  
	                      ...
	                      <td class="text-center">
	                        ...
	                        <a href="${pageContext.request.contextPath}/region/deleteRegion?rid=${region.rid}" class="layui-btn layui-btn-xs layui-btn-danger">删除</a>
	                        </div>
	                      </td>
                      </tr>
                      </c:forEach>
                      <tr>
                      	<td colspan="3" style="text-align:center">
							<a href="${pageContext.request.contextPath}/region/getAllRegion?pageNum=${pageInfo.prePage}">上一页</a>
							<c:forEach begin="1" end="${pageInfo.pages}" varStatus="pageNum">
								<a href="${pageContext.request.contextPath}/region/getAllRegion?pageNum=${pageNum.index}">${pageNum.index}</a>
							</c:forEach>
							<a href="${pageContext.request.contextPath}/region/getAllRegion?pageNum=${pageInfo.nextPage}">下一页</a>
                      	</td>
                      </tr>
