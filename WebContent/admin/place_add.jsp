...
<body>
    ...
    <div class="wrapper" style="width:1250px;height:800px;margin-left:-10px;margin-top:-20px">
        ...
        <div class="page-content">
          <div class="content">
            <!-- 右侧内容框架，更改从这里开始 -->
            <form action="${pageContext.request.contextPath}/place/addPlace" method="post" enctype="multipart/form-data" class="layui-form">
				<div class="layui-form-item">
                    <label for="L_repass" class="layui-form-label">
                        <span class="x-red">*</span>地点名称
                    </label>
                    <div class="layui-input-inline">
                    	<select id="L_repass" name="rid" required="" lay-verify="repass"
                        autocomplete="off" class="layui-input">
                        	<c:forEach var="region" items="${regions}">
                        		 <option value ="${region.rid}">${region.name}</option>
                        	</c:forEach>
				...
				<div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="file" id="L_repass" name="placeImg" required="" lay-verify="repass"
                        autocomplete="off" class="layui-input">
                    </div>					
                </div>
                <div class="layui-form-item">
                    ...
                    <input type="submit"  class="layui-btn" lay-filter="add" lay-submit="" value="添加照片">
                </div>
            </form>
