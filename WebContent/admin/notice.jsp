    ...
    <div class="wrapper" style="width:1250px;height:800px;margin-left:-10px;margin-top:-20px">
        ...
        <div class="page-content">
          <div class="content">
            ...
            <xblock><button class="layui-btn layui-btn-danger" onclick="recoverAll()">通知查询</button></xblock>
            <table class="layui-table" style="text-align:center">
                <thead >
                	<tr>
                      <th style="text-align:center;">被通知对象id</th>
                      <th style="text-align:center;">发布人id</th>
                	...
                	<c:forEach var="notice" items="${pageInfo.list}">
                      <tr style="height:120px;">	           			  	                      
	                      ...
	                      <td class="text-center">
	                        <div class="layui-btn-group">
	                        	 ...
	                        	 <a href="${pageContext.request.contextPath}/notice/deleteNotice?nid=${notice.nid}" class="layui-btn layui-btn-xs layui-btn-danger">删除</a>
                      ...
                      <tr>
                      	<td colspan="7" style="text-align:center">
							<a href="${pageContext.request.contextPath}/notice/getAllNotice?pageNum=${pageInfo.prePage}">上一页</a>
							<c:forEach begin="1" end="${pageInfo.pages}" varStatus="pageNum">
								<a href="${pageContext.request.contextPath}/notice/getAllNotice?pageNum=${pageNum.index}">${pageNum.index}</a>
							</c:forEach>
							<a href="${pageContext.request.contextPath}/notice/getAllNotice?pageNum=${pageInfo.nextPage}">下一页</a>
                      	</td>
                      </tr>
