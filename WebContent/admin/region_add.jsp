...
<body>
    ...
    <div class="wrapper" style="width:1250px;height:800px;margin-left:-10px;margin-top:-20px">
        ...
        <div class="page-content">
          <div class="content">
            <!-- 右侧内容框架，更改从这里开始 -->
           <form action="${pageContext.request.contextPath}/region/addRegion" method="post" class="layui-form">
                ...
                <div class="layui-form-item">
                    ...
                    <input type="submit"  class="layui-btn" lay-filter="add" lay-submit="" value="添加地区">
                </div>
            </form>
