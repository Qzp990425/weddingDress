	...
	<div class="container" style="margin-top:50px;"> 
		<div class="row">
			<div class="list-group col-4" style="display:inline-block">
				  ...
				  <a href="${pageContext.request.contextPath}/orderRecord/getOrderByUid" class="list-group-item list-group-item-action active">个人预定</a>
                ...
                <tbody>
                	<c:forEach var="order" items="${pageInfo.list}">
                      <tr>
	                      ...
	                      <td><img src="${pageContext.request.contextPath}/dressImg/${order.dress.uuid}.jpg" style="width:100px;height:100px;"></td>                      
						  <c:if test="${order.place!=null}">
	                      ...
	                      <td class="text-center">
	                        <div class="layui-btn-group">
	                        	<c:if test="${order.status==1}">
	                        	 <a href="${pageContext.request.contextPath}/orderRecord/finishOrder?oid=${order.oid}" class="layui-btn layui-btn-xs layui-btn-danger">拍摄完成</a>
	                          </c:if>
	                        </div>
	                      </td>
                      </tr>
                      ...
                      <tr>
                      	<td colspan="7" style="text-align:center">
							<a href="${pageContext.request.contextPath}/orderRecord/getOrderByUid?pageNum=${pageInfo.prePage}">上一页</a>
							<c:forEach begin="1" end="${pageInfo.pages}" varStatus="pageNum">
								<a href="${pageContext.request.contextPath}/orderRecord/getOrderByUid?pageNum=${pageNum.index}">${pageNum.index}</a>
							</c:forEach>
							<a href="${pageContext.request.contextPath}/orderRecord/getOrderByUid?pageNum=${pageInfo.nextPage}">下一页</a>
                      	</td>
                      </tr>
					</table>
                </tbody>
