	...
	<div class="container" style="margin-top:50px;"> 
		<div class="row">
			<div class="list-group col-4" style="display:inline-block">
				  <a href="${pageContext.request.contextPath}/user/myMsg.jsp" class="list-group-item list-group-item-action active">
				    	欢迎页面
				  </a>
			...
			<div class="col-8" style="display:inline-block;border:1px solid;position: absolute;">
				欢迎您来到个人主页，在这里你可以查看自己的订单、以及管理员给您发送的消息，并且更改自己的密码。
			</div>
		</div>
	</div>
	<!--- //blog -->  
